...
const Test = lazy(() =>
  delayForDemo(
    Promise.resolve({ default: () => <h2>测试延迟加载组件嵌套使用</h2> })
  )
);
                    ...
                    <div className={styles["testimonial-item"]}>
                      <div className={styles["testimonial-box"]}>
                        <div className={styles["testimonial-text"]}>
                          <p>
                            Donec semper euismod nisi quis feugiat. Nullam
                            finibus metus eget orci volutpat porta. Morbi quis
                            arcu vulputate, dignissim mi ac, varius magna.
